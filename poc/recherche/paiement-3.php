...
<body>
    ...
    <div id="btnr">
     ...
     <section class="contenu-page">
            <form method="post" id="formulaire-paiement" action="index.php">
                <fieldset>
                    <legend>Étape 3/3 - Confirmation</legend>
                    ...
                    <div id="informations-cote">
                        <div id="montants">
                            ...
                            <div id="adresse-livraison">
                                <p>Nom Prénom</p>
                                <p>12-123 Rue Nomderue</p>
                                <p>Ville, Pays Province X1Y 2Z3</p>
                            </div>
                            ...
                            <div id="action-formulaire">
                                <input type="submit" value="Payer" name="action-paiement-3">
                            </div>
                        </div>
                    </div>
                </fieldset>
