...
<html>
	...
	<div class="barre-navigation">
        ...
        <?php if(isset($_SESSION['membre']['id'])){ ?>
            <a class="navigation-utilisateur" href="deconnexion.php">Se déconnecter</a>
            <a class="navigation-utilisateur" href="profil.php">Espace membre</a>
        ...
        <div class="content">
            ...
            {
              if ($_GET['q'] == null) {$output = 'console.log(' . json_encode($data) . ');';}
